...
export default function Card({imagem, title, description, link}){
    return(
        <>
            <div className="cardAnime w-[400px] h-[580px] bg-[var(--color-three)] flex flex-col items-center justify-between rounded-3xl">
                {imagem && <div className="mb-5 h-[50%]"> {imagem} </div>}
